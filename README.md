## Телеграм-бот (aiogram) — учебный эхо-бот с поддержкой LLM

Продвинутый эхо-бот на `aiogram`, оформленный по профессиональной структуре проекта:

- конфигурация и переменные окружения;
- раздельные модули для роутеров, сервисов и утилит;
- логирование в консоль и в файл;
- поддержка взаимодействия с LLM через OpenRouter API;
- управление историей диалогов (в памяти или Redis);
- обработка ошибок и таймаутов при работе с LLM.
...
pip install -r requirements.txt
# Создайте .env вручную с токеном бота
python -m src.bot
```
